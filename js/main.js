...
ymaps__WEBPACK_IMPORTED_MODULE_0__["default"].load('https://api-maps.yandex.ru/2.1/?apikey=5f264f26-e07e-4f77-a379-3b0fa55eb0ab&lang=ru_RU').then(maps => {
...
if (promotionsSlider) {
  const promotionsSliderSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](promotionsSlider, {
    slidesPerView: 1,
    spaceBetween: 20,
    loop: true,
    loopedSlides: 5,
